...
Route name | kebab-case with dot notation                                              | users.show-active                       | ~~users.show_active, show-active-users~~
...
Contract (interface) | adjective or noun                                                         | AuthenticationContract                  | ~~Authenticatable, IAuthentication~~
